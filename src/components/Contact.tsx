      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="bg-white p-10 shadow-2xl relative">
             <div className="absolute top-0 left-0 w-2 h-full bg-hotel-primary"></div>
             ...
             <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                   <div className="space-y-2">
                     ...
                     <input className="w-full border-b border-gray-100 py-2 focus:outline-none focus:border-hotel-primary" type="text" placeholder="John Doe" />
                   </div>
                   <div className="space-y-2">
                     <label className="text-[10px] uppercase font-bold tracking-widest text-gray-400">Email Address</label>
                     <input className="w-full border-b border-gray-100 py-2 focus:outline-none focus:border-hotel-primary" type="email" placeholder="john@example.com" />
                   </div>
                </div>
                <div className="space-y-2">
                   <label className="text-[10px] uppercase font-bold tracking-widest text-gray-400">Subject</label>
                   <input className="w-full border-b border-gray-100 py-2 focus:outline-none focus:border-hotel-primary" type="text" placeholder="Reservation Inquiry" />
                </div>
                <div className="space-y-2">
                   <label className="text-[10px] uppercase font-bold tracking-widest text-gray-400">Message</label>
                   <textarea rows={4} className="w-full border-b border-gray-100 py-2 focus:outline-none focus:border-hotel-primary resize-none" placeholder="Tell us more..."></textarea>
                </div>
                <button className="w-full bg-hotel-dark text-white py-4 uppercase tracking-[0.2em] font-bold text-xs hover:bg-hotel-primary transition-colors duration-300">
                   Send Message
                </button>
             </form>
          </div>
