          ...
          <div className="bg-hotel-dark/90 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
            ...
            <div className="flex items-center gap-4 w-full md:w-auto">
              ...
              <button 
                ...
                className="flex-[2] md:flex-none px-8 py-3 bg-[#25D366] text-white rounded-xl text-[10px] uppercase tracking-[0.2em] font-bold hover:brightness-110 transition-all shadow-xl shadow-[#25D366]/20"
              >
                Accept All
              </button>
            </div>
